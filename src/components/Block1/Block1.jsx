    ...
    <div className={styles.Block1}>
      <div className={styles.Block1_Info}>
        <span>
          ...
          – многогранный исследовательский
        ...
        <span>
          <strong className={styles.Block1_Info_Tee}>ВИДЕОАНАЛИТИКА</strong>– наиболее оптимальный инструмент с
          точки зрения бюджета и количества обрабатываемых данных. С его помощью
          вы всегда будете в курсе актуальной информации на местах, а проработка
          алгоритмов персонального обслуживания успешно повысит конверсию
